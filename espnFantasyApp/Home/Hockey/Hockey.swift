...
import Foundation
import UIKit
class HockeyHeader: UICollectionReusableView {
...
class Hockey: BaseCell, UICollectionViewDataSource, UICollectionViewDelegate, UICollectionViewDelegateFlowLayout {
